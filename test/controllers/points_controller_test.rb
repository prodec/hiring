...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { conservacao: @point.conservacao, rodovia: @point.rodovia, sentido: @point.sentido, tipo: @point.tipo }
    end
  ...
  test "should update point" do
    patch :update, id: @point, point: { conservacao: @point.conservacao, rodovia: @point.rodovia, sentido: @point.sentido, tipo: @point.tipo }
    assert_redirected_to point_path(assigns(:point))
  end
